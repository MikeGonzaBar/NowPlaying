...
interface DashboardStats {
  ...
  scope: { days: number | null; label: string };
}
...
function MusicDashboard() {
  ...
  const fetchAllData = async () => {
    ...
    try {
      ...
      const response = await authenticatedFetch(
        getApiUrl(
          `${API_CONFIG.MUSIC_ENDPOINT}/fetch-lastfm-recent/?async=true`,
        ),
      );
      ...
      if (response.ok) {
        ...
        const pollForUpdates = async () => {
          ...
          if (pollCount > maxPolls) {
            ...
            setFetching(false);
            alert(
              "Data fetch is taking longer than expected. Please refresh the page manually to see updates.",
            );
            return;
          }
          ...
          if (newStats && newStats.total_scrobbles > initialScrobbles) {
            ...
            setFetching(false);
            alert(
              `Data fetch complete! Found ${newStats.total_scrobbles - initialScrobbles} new scrobbles.`,
            );
          }
        };
          ...
          >
            <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
              <Box sx={{ position: "relative" }}>
                ...
                >
                  <VerifiedIcon style={{ fontSize: 14, color: "white" }} />
                </Box>
              </Box>
              <Box>
                <Box
                ...
                >
                  <LocationOnIcon style={{ fontSize: 16, color: "#71717a" }} />
                  {stats.user_info.location && (
                    <span>{stats.user_info.location} • </span>
                  )}
                  {stats.user_info.member_since && (
                    <span>Since {stats.user_info.member_since}</span>
                  )}
                </Box>
              </Box>
            </Box>
            ...
            >
              <Box sx={{ textAlign: { xs: "center", md: "left" } }}>
                ...
                <Box sx={{ color: "#71717a", fontSize: "11px", mt: 0.5 }}>
                  {stats.scope.label}
                </Box>
              </Box>
              <Box
              ...
              >
                  ...
                  {(["30D", "90D", "1Y", "ALL"] as const).map((range) => (
                    <Button
                      ...
                      sx={{
                        ...
                        bgcolor:
                          timeRange === range ? "#e11d48" : "transparent",
                        minWidth: "auto",
                        "&:hover": {
                          bgcolor:
                            timeRange === range
                ...
                <Box sx={{ display: "flex", gap: 1 }}>
                  ...
                  >
                    {fetching ? "Refreshing..." : "Refresh listening history"}
                  </Button>
                </Box>
              </Box>
            </Box>
        ...
        >
            ...
            >
              ...
              >
                <Box>
                  ...
                  >
                    <TrendingUpIcon
                      style={{ color: "#e11d48", fontSize: 20 }}
                    />
                    Listening Trends
                  </Box>
                  <Box sx={{ fontSize: "12px", color: "#71717a" }}>
                    {avgPerDay > 0
                      ? `Average: ${avgPerDay.toFixed(1)} scrobbles per day`
              ...
              <Box sx={{ position: "relative", height: 250, width: "100%" }}>
                      ...
                      <defs>
                        ...
                        >
                          ...
                          <stop
                            offset="100%"
                            style={{
                              stopColor: "rgba(225, 29, 72, 0)",
                              stopOpacity: 1,
                            }}
                          />
                        </linearGradient>
                      </defs>
                      <path d={trendPaths.area} fill="url(#grad)" />
                      <path
                        d={trendPaths.path}
                        fill="none"
                        stroke="#e11d48"
                ...
                >
                  {stats.listening_trends.daily_data.length > 0 && (
                    <>
                      <span>
                        {formatDate(stats.listening_trends.daily_data[0].date)}
                      </span>
                      {stats.listening_trends.daily_data.length > 1 && (
                        <>
                          <span>
                            {formatDate(
                              stats.listening_trends.daily_data[
                                Math.floor(
                                  stats.listening_trends.daily_data.length / 4,
                                )
                              ].date,
                            )}
                          </span>
                          <span>
                            {formatDate(
                              stats.listening_trends.daily_data[
                                Math.floor(
                                  stats.listening_trends.daily_data.length / 2,
                                )
                              ].date,
                            )}
                          </span>
                          <span>
                            {formatDate(
                              stats.listening_trends.daily_data[
                                Math.floor(
                                  (stats.listening_trends.daily_data.length *
                                    3) /
                                  4,
                                )
                              ].date,
                    ...
                    return (
                      <Box
                        ...
                        sx={{
                          ...
                          alignItems: "center",
                          gap: 1,
                          cursor: artist.artist_lastfm_url
                            ? "pointer"
                            : "default",
                          transition: "all 0.2s",
                    ...
                    return (
                      <Box
                        ...
                        sx={{
                          ...
                          border: "1px solid #27272a",
                          cursor:
                            album.track_url || album.artist_lastfm_url
                              ? "pointer"
                              : "default",
                          transition: "all 0.3s",
                          "&:hover": {
                      ...
                      >
                        ...
                        >
                          ...
                          <Box sx={{ fontSize: "9px", color: "#e11d48" }}>
                            {album.count} Plays
                          </Box>
                        </Box>
                      </Box>
                    ...
                    return (
                      <Box
                        ...
                        sx={{
                          ...
                          gap: 1,
                          cursor:
                            track.track_url || track.artist_lastfm_url
                              ? "pointer"
                              : "default",
                          transition: "all 0.2s",
                          "&:hover":
          ...
          <Box sx={{ display: "flex", flexDirection: "column", gap: 1.5 }}>
            ...
            >
              ...
              >
                <EmojiEventsIcon style={{ color: "#e11d48", fontSize: 16 }} />
                Milestones
              </Box>
              <Box sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
                {stats.milestones.slice(0, 2).map((milestone, idx) => (
                  ...
                  >
                    {milestone.completed ? (
                      <MilitaryTechIcon
                        style={{ color: "#fbbf24", fontSize: 20, marginTop: 2 }}
                      />
                    ) : (
                      <StarsIcon
                        style={{ color: "#71717a", fontSize: 20, marginTop: 2 }}
                      />
                    )}
                    <Box sx={{ flex: 1 }}>
                      ...
                      <Box sx={{ fontSize: "11px", color: "#71717a" }}>
                ...
                {stats.recent_activity.map((activity, idx) => (
                  <Box
                    ...
                    sx={{
                      ...
                      gap: 1,
                      position: "relative",
                      mb: idx < stats.recent_activity.length - 1 ? 1 : 0,
                    }}
                  >
                    <Box
                      sx={{
                    ...
                    <Box
                      sx={{
                        pb: idx < stats.recent_activity.length - 1 ? 1 : 0,
                      }}
                    >
                      <Box
                        sx={{
                      ...
                      <Box sx={{ fontSize: "10px", color: "#71717a" }}>
                        {activity.artist}
                      </Box>
                      <Box
                        sx={{
            ...
            {stats.loved_highlight && (
              ...
              >
                ...
                >
                  <FavoriteIcon style={{ color: "#e11d48", fontSize: 16 }} />
                  Loved Highlights
                </Box>
                <Box
                  sx={{
                ...
                >
                  ...
                  >
                    <Box sx={{ fontSize: "12px", fontWeight: 700 }}>
                      {stats.loved_highlight.title}
                    </Box>
                    <Box sx={{ fontSize: "10px", color: "#a1a1aa" }}>
                      {stats.loved_highlight.artist}
                    </Box>
                  </Box>
                </Box>
              </Box>
