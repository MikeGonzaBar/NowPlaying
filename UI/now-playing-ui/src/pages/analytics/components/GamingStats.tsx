...
const GamingStats: React.FC<GamingStatsProps> = ({ data }) => {
  ...
  const completionRate = comprehensive_stats.totals.total_games_completed
    ? (
        (comprehensive_stats.totals.total_games_completed / totalGames) *
        100
      ).toFixed(1)
    : "0.0";
  ...
  const maxHours = Math.max(
    ...dailyActivityData.map((d: any) => d.hoursPerDay),
    1,
  );
  ...
  return (
    <Box sx={{ fontFamily: "'Inter', sans-serif" }}>
        ...
        >
          <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
            ...
            <Box sx={{ flex: 1 }}>
              ...
              >
                Completed games ÷ total platform records
              </Typography>
            </Box>
          </Box>
        </Card>
      ...
      <Box sx={{ mb: 6 }}>
        ...
        >
          Playtime is unavailable for providers that do not report it and is
          excluded from time totals.
        </Typography>
        <Box
          sx={{
            display: "grid",
        ...
        >
          ...
          <Box sx={{ display: "flex", alignItems: "center", gap: 2, mb: 4 }}>
            ...
            <Box>
              ...
              <Typography
                sx={{ fontSize: "1.875rem", fontWeight: 700, color: "#fff" }}
              >
        ...
        >
          ...
          {gaming_streaks.length > 0 ? (
            ...
            <Box sx={{ py: 4 }}>
              ...
              >
                <CalendarTodayIcon
                  sx={{ color: "#475569", fontSize: "1.5rem" }}
                />
              </Box>
              <Typography
                sx={{
              ...
              >
                No gaming streaks recorded yet.
                <br />
                Start playing daily to build your streak!
              </Typography>
            </Box>
          )}
        </Card>
      ...
      >
        ...
        >
          {dailyActivityData.map((day: any, index: number) => {
            const hoursHeight =
              maxHours > 0 ? (day.hoursPerDay / maxHours) * 100 : 0;
            const sessionHeight =
              maxHours > 0 ? (day.avgSession / maxHours) * 100 : 0;
            return (
              <Box
                key={index}
                sx={{
