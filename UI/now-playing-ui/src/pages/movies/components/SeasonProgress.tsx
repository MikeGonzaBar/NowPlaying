  ...
  return (
    <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
      ...
      <Box sx={{ display: "flex", flexDirection: "column", gap: 1.5 }}>
        {seasons.map((season) => {
          const { watched, total, percentage } = getSeasonProgress(
                  ...
                  <Box
                    sx={{
                      ...
                      backgroundImage: episodes[0]?.image_url
                        ...
                        : "none",
                      backgroundColor: episodes[0]?.image_url
                        ? "transparent"
                        : "#27272a",
                ...
                <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                  ...
                  {locked ? (
                    ...
                    <IconButton
                      ...
                      aria-label={`${expanded ? "Collapse" : "Expand"} Season ${season.season_number}`}
                        ...
                        sx={{
                          ...
                          ...(selectedSeason === season.season_number &&
                            ...
                            ? {
                              ...
                              boxShadow: "0 0 0 2px rgba(237, 28, 36, 0.2)",
                            }
                            : {}),
                          "&:hover": {
                            backgroundColor: "rgba(255, 255, 255, 0.05)",
