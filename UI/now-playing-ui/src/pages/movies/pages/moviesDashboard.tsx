  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const completedData = completedRes.ok
        ...
        : { completed_shows: [], completed_movies: [] };
  ...
  if (loading) {
    return (
      ...
      >
        ...
        >
          <Typography sx={{ color: "#fff" }}>Loading movies and shows...</Typography>
        </Box>
      </Box>
    );
  }
  ...
  return (
    ...
    >
      ...
      >
        <Container
          maxWidth="xl"
          sx={{ padding: 0, minWidth: 0, maxWidth: "100%" }}
        >
          <Grid
            container
            spacing={3}
            sx={{ width: "100%", minWidth: 0, overflowX: "clip" }}
          >
            {/* Main Content */}
