...
import { cleanAchievementDescription } from "../utils/utils";
...
const MasterAchievementList: React.FC<MasterAchievementListProps> = ({
  game,
}) => {
          ...
          {(["All", "Unlocked", "Locked"] as FilterType[]).map((filterType) => (
            <Button
              ...
              sx={{
                ...
                textTransform: "none",
                color:
                  filter === filterType ? zincColors.white : zincColors.muted,
                backgroundColor:
                  filter === filterType
                    ? "rgba(59, 130, 246, 0.2)"
                    : "transparent",
                border: `1px solid ${
                  filter === filterType ? "rgba(59, 130, 246, 0.5)" : "#27272a"
                }`,
                borderRadius: 1,
                "&:hover": {
                  backgroundColor:
              ...
              <Chip
                ...
                sx={{
                  ...
                  backgroundColor: achievement.unlocked
                    ? "rgba(34, 197, 94, 0.2)"
                    : "rgba(39, 39, 42, 0.8)",
                  color: achievement.unlocked ? "#22c55e" : zincColors.muted,
                  border: `1px solid ${
                    achievement.unlocked ? "rgba(34, 197, 94, 0.3)" : "#27272a"
                  }`,
                }}
              />
            </Box>
